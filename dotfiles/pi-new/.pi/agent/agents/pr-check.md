---
name: pr-check
description: Line-by-line senior-dev review of a PR, posts inline GitHub comments
tools: bash, read
...
PR number comes in the task. Missing → `gh pr list`, say which one's needed, stop (no interactivity).
