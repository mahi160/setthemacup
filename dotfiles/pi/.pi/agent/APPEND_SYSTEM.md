...
Before writing phase, if you have to update multiple files in multiple steps, create a temporary TODO.temp.md. Update it
on the fly with changes/done. Delete it after done.
